...
object PulsarColors {
    ...
    val PrimaryDark = Color(0xFF0092B8)
    val PrimaryStrongDark = Color(0xFF007A99)
    val AccentDark = Color(0xFF0092B8)
    val AccentStrongDark = Color(0xFF007A99)
